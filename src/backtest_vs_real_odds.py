...
BETS = [
    ...
    # Kayttajan pyynnosta (2026-09-18) "hae myos muiden stagejen kertoimet,
    # IEM Cologne on iso turnauskokonaisuus" - haettu tips.gg:n koko
    # IEM Cologne Major 2026 Stage 1-3 -sarja (GGbet-kertoimet, 7
    # artikkelia). Ajankohdat VARMISTETTU itse omasta datastamme kuten
    # aina. Kaksi ottelua (SINNERS Esports vs FlyQuest R1, THUNDER
    # dOWNUNDER vs FlyQuest R4) JATETTIIN POIS koska kumpikaan joukkue ei
    # ole top50-listalla - kummankaan omaa ottelusivua ei ole koskaan
    # haettu, joten ottelua ei loydy datastamme lainkaan (ei kehapaatelmaa,
    # vaan aito puuttuva havainto). Muutamalla ottelulla toinen joukkue
    # (Gaimin Gladiators, Sharks Esports, SINNERS Esports, THUNDERdOWNUNDER)
    # ei ole top50, joten sen Elo-rating perustuu VAIN top50-vastustajien
    # kautta havaittuihin otteluihin - todennakoisesti "OHUT DATA".
    # Stage 1, Round 1 (02.06.2026):
    {"date": "2026-06-02T12:50:00+00:00", "team": "HEROIC", "opponent": "Sharks Esports",
     "price": 1.30, "opponent_price": 3.40,
     "bet_on": None, "actual_winner": "Sharks Esports",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 1 R1]"},
    {"date": "2026-06-02T11:45:00+00:00", "team": "MIBR", "opponent": "THUNDERdOWNUNDER",
     "price": 1.35, "opponent_price": 3.10,
     "bet_on": None, "actual_winner": "THUNDERdOWNUNDER",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 1 R1]"},
    {"date": "2026-06-02T10:30:00+00:00", "team": "M80", "opponent": "Lynn Vision",
     "price": 1.49, "opponent_price": 2.53,
     "bet_on": None, "actual_winner": "M80", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R1]"},
    {"date": "2026-06-02T14:25:00+00:00", "team": "BIG", "opponent": "Liquid",
     "price": 1.68, "opponent_price": 2.16,
     "bet_on": None, "actual_winner": "Liquid",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 1 R1]"},
    {"date": "2026-06-02T14:00:00+00:00", "team": "BETBOOM", "opponent": "Gaimin Gladiators",
     "price": 1.44, "opponent_price": 2.74,
     "bet_on": None, "actual_winner": "BETBOOM", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R1]"},
    {"date": "2026-06-02T12:00:00+00:00", "team": "B8", "opponent": "TYLOO",
     "price": 1.63, "opponent_price": 2.24,
     "bet_on": None, "actual_winner": "B8", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R1]"},
    {"date": "2026-06-02T13:05:00+00:00", "team": "GamerLegion", "opponent": "NRG",
     "price": 1.43, "opponent_price": 2.74,
     "bet_on": None, "actual_winner": "GamerLegion", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R1]"},
    # Stage 1, Round 3 (03.06.2026):
    {"date": "2026-06-03T12:30:00+00:00", "team": "Sharks Esports", "opponent": "Lynn Vision",
     "price": 1.89, "opponent_price": 1.91,
     "bet_on": None, "actual_winner": "Lynn Vision", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R3]"},
    {"date": "2026-06-03T12:30:00+00:00", "team": "NRG", "opponent": "FlyQuest",
     "price": 2.02, "opponent_price": 1.79,
     "bet_on": None, "actual_winner": "NRG",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 1 R3]"},
    {"date": "2026-06-03T13:35:00+00:00", "team": "THUNDERdOWNUNDER", "opponent": "BIG",
     "price": 3.92, "opponent_price": 1.25,
     "bet_on": None, "actual_winner": "BIG", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R3]"},
    {"date": "2026-06-03T13:40:00+00:00", "team": "Liquid", "opponent": "MIBR",
     "price": 2.01, "opponent_price": 1.80,
     "bet_on": None, "actual_winner": "MIBR",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 1 R3]"},
    {"date": "2026-06-03T14:40:00+00:00", "team": "TYLOO", "opponent": "SINNERS Esports",
     "price": 1.93, "opponent_price": 1.87,
     "bet_on": None, "actual_winner": "TYLOO", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R3]"},
    {"date": "2026-06-03T14:50:00+00:00", "team": "GamerLegion", "opponent": "BETBOOM",
     "price": 2.10, "opponent_price": 1.73,
     "bet_on": None, "actual_winner": "BETBOOM", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R3]"},
    {"date": "2026-06-03T17:00:00+00:00", "team": "Gaimin Gladiators", "opponent": "HEROIC",
     "price": 6.00, "opponent_price": 1.12,
     "bet_on": None, "actual_winner": "HEROIC", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R3]"},
    {"date": "2026-06-03T17:00:00+00:00", "team": "M80", "opponent": "B8",
     "price": 2.17, "opponent_price": 1.69,
     "bet_on": None, "actual_winner": "B8",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 1 R3]"},
    # Stage 1, Round 4 (04.06.2026):
    {"date": "2026-06-04T12:00:00+00:00", "team": "TYLOO", "opponent": "Sharks Esports",
     "price": 1.54, "opponent_price": 2.47,
     "bet_on": None, "actual_winner": "TYLOO", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R4]"},
    {"date": "2026-06-04T14:30:00+00:00", "team": "GamerLegion", "opponent": "BIG",
     "price": 1.79, "opponent_price": 2.02,
     "bet_on": None, "actual_winner": "GamerLegion", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R4]"},
    {"date": "2026-06-04T15:05:00+00:00", "team": "MIBR", "opponent": "Lynn Vision",
     "price": 1.66, "opponent_price": 2.23,
     "bet_on": None, "actual_winner": "MIBR", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R4]"},
    {"date": "2026-06-04T17:00:00+00:00", "team": "Liquid", "opponent": "HEROIC",
     "price": 2.09, "opponent_price": 1.74,
     "bet_on": None, "actual_winner": "Liquid",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 1 R4]"},
    {"date": "2026-06-04T17:00:00+00:00", "team": "M80", "opponent": "NRG",
     "price": 1.66, "opponent_price": 2.23,
     "bet_on": None, "actual_winner": "M80", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R4]"},
    # Stage 1, Round 5 (05.06.2026):
    {"date": "2026-06-05T12:00:00+00:00", "team": "TYLOO", "opponent": "Lynn Vision",
     "price": 1.48, "opponent_price": 2.66,
     "bet_on": None, "actual_winner": "TYLOO", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R5]"},
    {"date": "2026-06-05T14:30:00+00:00", "team": "Liquid", "opponent": "FlyQuest",
     "price": 1.62, "opponent_price": 2.31,
     "bet_on": None, "actual_winner": "FlyQuest",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 1 R5]"},
    {"date": "2026-06-05T17:00:00+00:00", "team": "NRG", "opponent": "BIG",
     "price": 2.88, "opponent_price": 2.23,
     "bet_on": None, "actual_winner": "BIG", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 1 R5]"},
    # Stage 2, Round 1 (06.06.2026):
    {"date": "2026-06-06T10:30:00+00:00", "team": "Astralis", "opponent": "GamerLegion",
     "price": 1.90, "opponent_price": 1.90,
     "bet_on": None, "actual_winner": "Astralis", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 2 R1]"},
    {"date": "2026-06-06T10:30:00+00:00", "team": "9z", "opponent": "FlyQuest",
     "price": 2.57, "opponent_price": 1.50,
     "bet_on": None, "actual_winner": "9z",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 2 R1]"},
    {"date": "2026-06-06T11:30:00+00:00", "team": "FUT", "opponent": "B8",
     "price": 2.30, "opponent_price": 1.62,
     "bet_on": None, "actual_winner": "FUT",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 2 R1]"},
    {"date": "2026-06-06T11:40:00+00:00", "team": "paiN", "opponent": "TYLOO",
     "price": 1.73, "opponent_price": 2.12,
     "bet_on": None, "actual_winner": "TYLOO",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 2 R1]"},
    {"date": "2026-06-06T12:40:00+00:00", "team": "G2", "opponent": "M80",
     "price": 1.32, "opponent_price": 3.32,
     "bet_on": None, "actual_winner": "G2", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 2 R1]"},
    {"date": "2026-06-06T12:45:00+00:00", "team": "Monte", "opponent": "BIG",
     "price": 1.74, "opponent_price": 2.10,
     "bet_on": None, "actual_winner": "Monte", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 2 R1]"},
    {"date": "2026-06-06T13:50:00+00:00", "team": "Spirit", "opponent": "BETBOOM",
     "price": 1.30, "opponent_price": 3.56,
     "bet_on": None, "actual_winner": "Spirit", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 2 R1]"},
    {"date": "2026-06-06T14:00:00+00:00", "team": "Legacy", "opponent": "MIBR",
     "price": 2.77, "opponent_price": 1.45,
     "bet_on": None, "actual_winner": "MIBR", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 2 R1]"},
    # Stage 3, Round 1 (11.06.2026):
    {"date": "2026-06-11T09:00:00+00:00", "team": "PARIVISION", "opponent": "9z",
     "price": 1.69, "opponent_price": 2.23,
     "bet_on": None, "actual_winner": "9z",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 3 R1]"},
    {"date": "2026-06-11T09:00:00+00:00", "team": "The MongolZ", "opponent": "BETBOOM",
     "price": 1.72, "opponent_price": 2.10,
     "bet_on": None, "actual_winner": "BETBOOM",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 3 R1]"},
    {"date": "2026-06-11T12:10:00+00:00", "team": "Vitality", "opponent": "FUT",
     "price": 1.19, "opponent_price": 4.493,
     "bet_on": None, "actual_winner": "Vitality", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 3 R1]"},
    {"date": "2026-06-11T12:10:00+00:00", "team": "MOUZ", "opponent": "Legacy",
     "price": 1.72, "opponent_price": 2.14,
     "bet_on": None, "actual_winner": "MOUZ", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 3 R1]"},
    {"date": "2026-06-11T15:05:00+00:00", "team": "Falcons", "opponent": "G2",
     "price": 1.46, "opponent_price": 2.90,
     "bet_on": None, "actual_winner": "Falcons", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 3 R1]"},
    {"date": "2026-06-11T14:10:00+00:00", "team": "FURIA", "opponent": "B8",
     "price": 1.31, "opponent_price": 3.35,
     "bet_on": None, "actual_winner": "FURIA", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 3 R1]"},
    {"date": "2026-06-11T18:40:00+00:00", "team": "Natus Vincere", "opponent": "Spirit",
     "price": 2.26, "opponent_price": 1.65,
     "bet_on": None, "actual_winner": "Spirit", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 3 R1]"},
    {"date": "2026-06-11T16:30:00+00:00", "team": "Aurora", "opponent": "Monte",
     "price": 1.58, "opponent_price": 2.44,
     "bet_on": None, "actual_winner": "Aurora", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 3 R1]"},
    # Stage 3, Round 2 (12.06.2026):
    {"date": "2026-06-12T09:00:00+00:00", "team": "FURIA", "opponent": "MOUZ",
     "price": 1.65, "opponent_price": 2.19,
     "bet_on": None, "actual_winner": "FURIA", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 3 R2]"},
    {"date": "2026-06-12T09:00:00+00:00", "team": "The MongolZ", "opponent": "B8",
     "price": 1.46, "opponent_price": 2.68,
     "bet_on": None, "actual_winner": "The MongolZ", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 3 R2]"},
    {"date": "2026-06-12T12:10:00+00:00", "team": "FUT", "opponent": "G2",
     "price": 1.81, "opponent_price": 1.97,
     "bet_on": None, "actual_winner": "G2", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 3 R2]"},
    {"date": "2026-06-12T11:30:00+00:00", "team": "PARIVISION", "opponent": "Monte",
     "price": 1.79, "opponent_price": 2.00,
     "bet_on": None, "actual_winner": "Monte",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 3 R2]"},
    {"date": "2026-06-12T14:40:00+00:00", "team": "Natus Vincere", "opponent": "Legacy",
     "price": 1.38, "opponent_price": 2.98,
     "bet_on": None, "actual_winner": "Natus Vincere", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 3 R2]"},
    {"date": "2026-06-12T15:10:00+00:00", "team": "Falcons", "opponent": "BETBOOM",
     "price": 1.46, "opponent_price": 2.67,
     "bet_on": None, "actual_winner": "BETBOOM",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 3 R2]"},
    {"date": "2026-06-12T17:25:00+00:00", "team": "Aurora", "opponent": "Spirit",
     "price": 6.30, "opponent_price": 1.11,
     "bet_on": None, "actual_winner": "Spirit", "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu) [tips.gg/GGbet, IEM Cologne Stage 3 R2]"},
    {"date": "2026-06-12T16:45:00+00:00", "team": "Vitality", "opponent": "9z",
     "price": 1.07, "opponent_price": 8.09,
     "bet_on": None, "actual_winner": "9z",
     "bet_type": "voittaja (Money Line, molemmat kertoimet tunnettu, ALIKERTOIMEN YLLATYS) [tips.gg/GGbet, IEM Cologne Stage 3 R2]"},
]
...
def main() -> int:
    ...
    # top50_only:n - ks. backtest.py:n sos_k_override()-kommentti). Kayttajan
    # alkuperainen huomio NRG:n vastustajien heikkoudesta johti taman
    # mekanismin olemassaoloon; validointi paivitettiin kun uudempi, laajempi
    # data (top75) osoitti pehmean painotuksen voittavan taydellisen
    # poissuodatuksen.
    ...
    for bet in BETS:
        ...
        for m in prior:
            elo_snapshot.update(m.team, m.opponent, m.team_won, m.date,
                                k_override=production_k_override(params["k_factor"], m.match_type,
                                                                   m.team, m.opponent, top50_names))
